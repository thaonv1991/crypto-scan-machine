...
rate_limiters.register("goplus", calls_per_minute=30)
rate_limiters.register("twitter", calls_per_minute=15)
rate_limiters.register("telegram", calls_per_minute=20)
rate_limiters.register("reddit", calls_per_minute=10)
rate_limiters.register("geckoterminal", calls_per_minute=10)
rate_limiters.register("defillama", calls_per_minute=30)
rate_limiters.register("coinmarketcap", calls_per_minute=10, calls_per_day=15000)
rate_limiters.register("jupiter", calls_per_minute=30)
rate_limiters.register("birdeye", calls_per_minute=10)
rate_limiters.register("dextools", calls_per_minute=10)
rate_limiters.register("solscan", calls_per_minute=5, calls_per_day=100)
rate_limiters.register("helius", calls_per_minute=10)
rate_limiters.register("pumpfun", calls_per_minute=30)
rate_limiters.register("pinksale", calls_per_minute=10)
rate_limiters.register("daomaker", calls_per_minute=10)
rate_limiters.register("binance_launchpad", calls_per_minute=10)
rate_limiters.register("youtube", calls_per_minute=5)
rate_limiters.register("lunarcrush", calls_per_minute=10)
rate_limiters.register("cryptorank", calls_per_minute=5, calls_per_day=100)
rate_limiters.register("tokensniffer", calls_per_minute=10)
